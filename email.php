...
// RECEBE OS VALORES VINDO DO FORMULÁRIO E ATRIBUI AS VARIÁVEIS
	...
	if (!$captcha_data) {
		echo '<p>Informações não enviadas. Não esqueça de fazer a verificação antes de enviar a mensagem.<br><br>Clique em <a href="index.html">AQUI</a> para tentar novamente</p>';
		exit;
	}
...
$assunto_da_mensagem_original="Este email quer receber novidades.";

// FORMA COMO RECEBERÁ O E-MAIL (FORMULÁRIO)
// ******** OBS: SE FOR ADICIONAR NOVOS CAMPOS, ADICIONE OS CAMPOS NA VARIÁVEL ABAIXO *************
$configuracao_da_mensagem_original="

O site do IBESVA recebeu a seguinte solicitacao de cadastramento de email para receber novidades:\n\n
Email: $email\n\n

...
if (isset($_POST['nome'])) {
	...
	if (!$captcha_data) {
		echo '<p>Informações não enviadas. Não esqueça de fazer a verificação antes de enviar a mensagem.<br><br>Clique em <a href="contato.html">AQUI</a> para tentar novamente</p>';
		exit;
	}
